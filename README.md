...
C++ statements are evaluated on the fly, possibly using the source code loaded, no matter if provided with the main function or if it is just a class declaration.
